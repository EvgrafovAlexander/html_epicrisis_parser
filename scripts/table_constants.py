    ...
    'Общий (клинический) анализ мочи':
        {
            ...
            'определение удельного веса': {'name': 'Определение удельного веса (относительной плотности) мочи',
                                           'type': 'class', 'unit': {'м\м': ['м\м']}},
            'определение белка в моче': {'name': 'Определение белка в моче',
                                         'type': 'class', 'unit': {'отр': ['отр']}},
            'leu': {'name': 'LEU', 'type': 'class', 'unit': {'1-2-2': ['1-2-2']}},
            'bld': {'name': 'BLD', 'type': 'class', 'unit': {'3-4-4': ['3-4-4']}}
        },
    'Кислотно-основное равновесие':
        {
            'id': {'name': 'id', 'type': '', 'unit': []},
            'дата': {'name': 'Дата', 'type': 'date', 'unit': ['']},
            'k+': {'name': 'Калий', 'type': 'float', 'unit': ['(ммоль/л)']},
